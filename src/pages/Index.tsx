...
export default function Index() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0f111a] text-slate-50 p-4">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 bg-[#0f111a] border-slate-800 placeholder:text-slate-600 focus-visible:ring-emerald-500"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 bg-[#0f111a] border-slate-800 focus-visible:ring-emerald-500 text-2xl tracking-widest font-mono"
              />
            </div>
          </div>
